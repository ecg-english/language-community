...
const en = {
  translation: {
    ...
    memberNumberPlaceholder: 'e.g., C1123456789012',
    memberNumberHelp: 'Please enter the member number provided by the manager',
    satisfactionRating: 'Satisfaction with Current Instructor*',
    satisfactionDescription: '1: Very Dissatisfied ~ 5: Very Satisfied',
    recommendationQuestion: 'Would you recommend this service to a friend?*',
    recommendationDescription: '0 (Not at all) ~ 10 (Strongly recommend)',
    instructorFeedback: 'Feedback for Instructor',
    instructorFeedbackExample: 'e.g., Explanation was easy to understand / I want more conversation practice',
    instructorFeedbackPlaceholder: 'Please share your feedback about the instructor',
    lessonFeedback: 'Feedback Regarding Lesson Content',
    lessonFeedbackExample: 'e.g., I want to add pronunciation practice / I want to adjust the amount of homework',
    lessonFeedbackPlaceholder: 'Please share your feedback about the lesson content',
    nextMonthGoals: 'What I Want to Learn Next Month',
    conversationSkills: 'Improve conversation skills',
    grammarAccuracy: 'Improve grammar accuracy',
    vocabulary: 'Increase vocabulary',
    pronunciation: 'Improve pronunciation',
    listening: 'Improve listening skills',
    examPreparation: 'Exam preparation (Eiken/TOEIC, etc.)',
    culture: 'Learn more about culture',
    otherComments: 'Other (Free Description)',
    otherCommentsExample: 'e.g., I want to practice customer service English for overseas travel',
    otherCommentsPlaceholder: 'Please share any other opinions or requests',
    submitSurvey: 'Submit Survey',
    submitting: 'Submitting...',
    surveySubmitted: 'Survey submitted. Thank you!',
    surveyCompleted: 'Survey completed for {{month}}',
    surveyCompletedDescription: 'Thank you for your cooperation.',
    submissionTime: 'Submission time',
    requiredFields: '* Satisfaction rating and member number are required',
    surveyError: 'Failed to submit survey. Please try again.',
    surveyDataError: 'Failed to load survey data.',
    unknown: 'Unknown',
...
const ja = {
  translation: {
    ...
    feedback: 'フィードバック',
    memberNumber: '会員番号',
    memberNumberPlaceholder: '例: ABC',
    memberNumberHelp: 'マネージャーからお渡しされた会員番号を入力してください',
    satisfactionRating: '現状の講師に対する満足度*',
    satisfactionDescription: '1: 非常に不満 ~ 5: 非常に満足',
    recommendationQuestion: 'このサービスを友人に勧めたいと思いますか?*',
    recommendationDescription: '0 (全く勧めない) ~ 10 (強く勧めたい)',
    instructorFeedback: '講師に対するフィードバック',
    instructorFeedbackExample: '例:説明がわかりやすかった/もっと会話量を増やしてほしい',
    instructorFeedbackPlaceholder: '講師についてのご意見をお聞かせください',
    lessonFeedback: 'レッスン内容に関するフィードバック',
    lessonFeedbackExample: '例:発音練習を追加したい/宿題の量を調整してほしい',
    lessonFeedbackPlaceholder: 'レッスン内容についてのご意見をお聞かせください',
    nextMonthGoals: '来月学びたいこと',
    conversationSkills: '会話スキルを伸ばしたい',
    grammarAccuracy: '文法の正確さを高めたい',
    vocabulary: '語彙を増やしたい',
    pronunciation: '発音を改善したい',
    listening: 'リスニングを鍛えたい',
    examPreparation: '試験対策(英検/TOEICなど)',
    culture: '文化についてももっと学びたい',
    otherComments: 'その他 (自由記述)',
    otherCommentsExample: '例:海外旅行で困らない接客英語を練習したい',
    otherCommentsPlaceholder: 'その他のご意見やご要望があればお聞かせください',
    submitSurvey: 'アンケートを送信',
    submitting: '送信中...',
    surveySubmitted: 'アンケートを送信しました。ありがとうございます！',
    surveyCompleted: '{{month}}のアンケートは実施済みです',
    surveyCompletedDescription: 'ご協力いただき、ありがとうございました。',
    submissionTime: '送信日時',
    requiredFields: '* 満足度評価と会員番号は必須項目です',
    surveyError: 'アンケートの送信に失敗しました。もう一度お試しください。',
    surveyDataError: 'アンケートデータの読み込みに失敗しました',
    unknown: '不明',
...
const jaSimple = {
  translation: {
    ...
    survey: 'アンケート',
    feedback: 'フィードバック',
    memberNumber: 'かいいんばんごう',
    memberNumberPlaceholder: 'れい: C1123456789012',
    memberNumberHelp: 'マネージャーからおわたしされたかいいんばんごうをにゅうりょくしてください',
    satisfactionRating: 'げんじょうのこうしにたいするまんぞくど*',
    satisfactionDescription: '1: ひじょうにふまん ~ 5: ひじょうにまんぞく',
    recommendationQuestion: 'このサービスをゆうじんにすすめたいとおもいますか?*',
    recommendationDescription: '0 (まったくすすめない) ~ 10 (つよくすすめたい)',
    instructorFeedback: 'こうしにたいするフィードバック',
    instructorFeedbackExample: 'れい:せつめいがわかりやすかった/もっとかいわりょうをふやしてほしい',
    instructorFeedbackPlaceholder: 'こうしについてのごいけんをおきかせください',
    lessonFeedback: 'レッスンないようにかんするフィードバック',
    lessonFeedbackExample: 'れい:はつおんれんしゅうをついかしたい/しゅくだいのりょうをちょうせいしてほしい',
    lessonFeedbackPlaceholder: 'レッスンないようについてのごいけんをおきかせください',
    nextMonthGoals: 'らいげつまなびたいこと',
    conversationSkills: 'かいわスキルをのばしたい',
    grammarAccuracy: 'ぶんぽうのせいかくさをたかめたい',
    vocabulary: 'ごいをふやしたい',
    pronunciation: 'はつおんをかいぜんしたい',
    listening: 'リスニングをきたえたい',
    examPreparation: 'しけんたいさく(えいけん/TOEICなど)',
    culture: 'ぶんかについてももっとまなびたい',
    otherComments: 'そのた (じゆうきじゅつ)',
    otherCommentsExample: 'れい:かいがいりょこうでこまらないせっきゃくえいごをれんしゅうしたい',
    otherCommentsPlaceholder: 'そのたのごいけんやごようぼうがあればおきかせください',
    submitSurvey: 'アンケートをそうしん',
    submitting: 'そうしんちゅう...',
    surveySubmitted: 'アンケートをそうしんしました。ありがとうございます！',
    surveyCompleted: '{{month}}のアンケートはじっしずみです',
    surveyCompletedDescription: 'ごきょうりょくいただき、ありがとうございました。',
    submissionTime: 'そうしんじかん',
    requiredFields: '* まんぞくどひょうかとかいいんばんごうはひっすこうもくです',
    surveyError: 'アンケートのそうしんにしっぱいしました。もういちどおためしください。',
    surveyDataError: 'アンケートデータのよみこみにしっぱいしました',
    unknown: 'ふめい',
